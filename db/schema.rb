...
ActiveRecord::Schema.define(version: 20170225062527) do
  ...
  create_table "canvases", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_canvases_on_user_id", using: :btree
  end
  ...
  create_table "notes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["canvas_id"], name: "index_notes_on_canvas_id", using: :btree
  end
